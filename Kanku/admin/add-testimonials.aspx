<%@ Page Title="" Language="C#" MasterPageFile="~/admin_master.Master" AutoEventWireup="true" CodeBehind="add-testimonials.aspx.cs" Inherits="Kanku.admin.add_testimonials" %>
                    ...
                    <form method="" ">
                        <div class="row">
                            ...
                            <div class="col-6" style="margin-top: 10px;">
                                ...
                                <asp:FileUpload ID="testimonial_img" runat="server" class="form-control"></asp:FileUpload>
                            </div>
